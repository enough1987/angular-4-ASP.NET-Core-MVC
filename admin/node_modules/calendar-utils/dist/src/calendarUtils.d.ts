...
export declare function getWeekViewHeader({viewDate, weekStartsOn, excluded}: GetWeekViewHeaderArgs): WeekDay[];
...
export declare function getMonthView({events, viewDate, weekStartsOn, excluded, viewStart, viewEnd}: GetMonthViewArgs): MonthView;
